...
// Parameters
final float squareSize = 10;
final float obstacleFreq = 0.4;
...
// Start and end nodes are initialized after canvas setup
Node start;
Node  goal;
...
public void setup() {
  ...
  openSet   = new HashSet<Node>(rows * cols);
...
void draw() {
  ...
  // Make a new node with a very high f value (the default) to act as "best node"
